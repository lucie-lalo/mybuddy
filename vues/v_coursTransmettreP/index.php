...
<html lang="en">
	...
	<body>
<!-- Navigation 1 -->
	<nav class="pb-30 bg-light text-center navigation_1 pt-10">
		<div class="container px-xl-0">
			<div class="row justify-content-center align-items-center f-16">
				...
				<div class="col-lg-6 mt-20 action-2 px-0 text-center" data-aos="fade-down" data-aos-delay="0">
					<a href="../../index.php?uc=gestion&action=voirElevesP" class="link bold f-18 mr-40 text-uppercase action-2">
						élèves
					</a>
					<a href="../../index.php?uc=gestion&action=voirCoursTransmettreP" class="link mx-15 bold f-18 text-center ml-0 mr-40 text-uppercase action-1">
						cours à transmettre
					</a>
	...
	<!-- Contact 2 -->
		<section class="bg-light text-center contact_2 pt-20 pb-60">
			<div class="text-adaptive bold text-uppercase f-36 action-1 mb-50">
				cours à transmettre
			</div>
			<div class="container px-xl-0">
					...
					<div class="row justify-content-center">
						<div class="col-xl-6 col-lg-8 col-md-10">
							<div data-aos="fade-down" data-aos-delay="500">
								<select name="unnamed-élèves" class="input w-full focus-action-1 color-heading placeholder-heading mb-30 border-action-2">
								...
								<input type="text" name="unnamed-input" placeholder="Matière" class="input focus-action-1 color-heading placeholder-heading w-full mb-30 border-action-2">
								<textarea name="message" placeholder="Commentaires..." required="required" class="input radius10 focus-action-1 color-heading placeholder-heading text-left mb-30 border-action-2 h-50 w-560">
								</textarea>
							</div>
						</div>
						<div class="col-12">
						</div>
						<div class="col-xl-4 col-lg-5 col-md-6 col-sm-7" data-aos="fade-down" data-aos-delay="750">
							<input type="email" name="email" placeholder="Parcourir" required="required" class="input mb-30 w-full focus-action-1 color-heading placeholder-heading text-center text-sm-left border-action-2">
						</div>
						<div class="col-xl-2 col-lg-3 col-md-4 col-sm-5" data-aos="fade-down" data-aos-delay="1000">
							<button class="btn mb-30 w-full action-1">
								Parcourir
							</button>
						</div>
					</div>
			...
			<a href="#" class="btn action-1 w-150">
				Envoyer
			</a>
		</section>
		<!-- forms alerts -->
