...
<!-- Navigation 1 -->
		...
		<div class="container px-xl-0">
			<div class="row justify-content-center align-items-center f-16">
				...
				<div class="col-lg-6 mt-20 action-2 px-0 text-center" data-aos="fade-down" data-aos-delay="0">
					...
					<a href="../../index.php?uc=gestion&action=voirSuiviP" class="link bold f-18 text-uppercase action-1">
						suivi pédagogique
					</a>
				</div>
	...
	<!-- Pricing table 1 -->
		<section class="bg-light text-center pricing_table_1 pt-40 pb-50">
				...
				<div class="row align-items-start no-gutters">
					<div class="col-lg-3">
						<div class="pt-45 radius10 noradius_right noborder_right block">
							<div class="f-22 title bold text-uppercase" data-aos="fade-down" data-aos-delay="0">
								nom / prénom
							</div>
			...
			<a href="#" class="btn action-1 mt-30">
				NOUVEL ENTRETIEN
			</a>
		</section>
		<!-- forms alerts -->
