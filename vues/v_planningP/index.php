...
<html lang="en">
	...
	<body>
<!-- Pricing table 1 -->
	<section class="bg-light text-center pricing_table_1 pt-40 pb-30">
		<div class="text-adaptive bold text-uppercase action-1 f-36 mb-45">
			planning d'absences
		</div>
			...
			<div class="row align-items-start no-gutters">
				<div class="col-lg-3">
					<div class="pt-45 radius10 noradius_right noborder_right block">
						<div class="f-22 title text-uppercase bold action-2" data-aos="fade-down" data-aos-delay="0">
							nom / prénom
						</div>
				...
				<div class="col-lg-3">
					<div class="pt-45 noborder_right block">
						...
						<div class="mt-10 mb-35 color-heading subtitle" data-aos="fade-down" data-aos-delay="500">
						</div>
				...
				<div class="col-lg-3">
					<div class="pt-45 radius10 noradius_left block">
						<div class="f-22 title bold text-uppercase action-2" data-aos="fade-down" data-aos-delay="750">
							détails absences
						</div>
						...
						<select name="unnamed-select" class="input w-full border-gray focus-action-1 color-heading placeholder-heading sm">
