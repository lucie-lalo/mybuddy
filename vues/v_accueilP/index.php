		...
		<section class="pb-90 bg-light text-center showcase_2 pt-15">
			<div class="container px-xl-0">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6" data-aos="fade-down" data-aos-delay="0">
						<a href="../../index.php?uc=gestion&action=voirDemandeRecuesP" class="link img_link color-main w-480 mt-50 mr-0 ml-150">
							<img src="uploads/sanstitre9.png" srcset="uploads/sanstitre9.png 2x" alt="" class="img-fluid radius10">
						</a>
						<a href="../../index.php?uc=gestion&action=voirDemandeRecuesP" class="btn action-1 w-230 ml-260">
							DEMANDES REÇUES
						</a>
					</div>
					<div class="col-md-4 col-sm-6" data-aos="fade-down" data-aos-delay="250">
					...
					<div class="col-md-4 col-sm-6" data-aos="fade-down" data-aos-delay="500">
						<a href="../../index.php?uc=gestion&action=voirSuiviP" class="link img_link color-main mt-50 w-240 mr-160">
							<img src="uploads/sanstitre11.png" srcset="uploads/sanstitre11.png 2x" alt="" class="img-fluid radius10">
						</a>
						<a href="../../index.php?uc=gestion&action=voirSuiviP" class="btn action-1 w-240 mr-170 mt-10">
							SUIVI PÉDAGOGIQUE
						</a>
					</div>
				</div>
