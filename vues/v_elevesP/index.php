...
<!-- Navigation 1 -->
		...
		<div class="container px-xl-0">
			<div class="row justify-content-center align-items-center f-16">
				...
				<div class="col-lg-6 mt-20 action-2 px-0 text-center" data-aos="fade-down" data-aos-delay="0">
					<a href="../../index.php?uc=gestion&action=voirElevesP" class="link bold f-18 mr-40 text-uppercase action-1">
						élèves
					</a>
	...
	<!-- Pricing table 1 -->
		<section class="bg-light text-center pricing_table_1 pt-40 pb-40">
			...
			<a href="#" class="btn action-1 text-uppercase mt-25">
				+ nouvel élève
			</a>
		</section>
		<!-- forms alerts -->
