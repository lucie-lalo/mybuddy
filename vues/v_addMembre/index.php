				...
				<div class="row justify-content-center">
					<div class="col-xl-15 col-lg-10">
						...
						<form action="addAdmin.php">
							<button class="button">Nouvel Admin</button>
						</form>
						<form action="addPedagogue.php">
							<button class="button button2">Nouveau Pédagogue</button>
						</form>
						<form action="addEleve.php">
							<button class="button button3">Nouvel élève</button>
						</form>
					</div>
				</div>
			</div>
